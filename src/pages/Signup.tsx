          ...
          >
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center mb-4">
                <Fingerprint
                  size={32}
                  className={`text-cyan-400 ${scanning ? "animate-pulse" : ""}`}
                />
              </div>
              <button
                type="button"
            ...
            <motion.div variants={fadeUp} className="flex flex-col gap-3 mb-6">
              ...
              >
                ...
                >
                  <path
                    d="M13.71 14.12c-.74 1.1-1.54 2.19-2.76 2.21-1.21.02-1.6-.72-2.98-.72s-1.81.7-2.96.74c-1.18.04-2.09-1.19-2.84-2.28C.62 11.72-.6 7.93.89 5.35A4.35 4.35 0 0 1 4.6 3.07c1.17-.02 2.27.79 2.98.79.72 0 2.06-.97 3.47-.83.59.02 2.24.24 3.3 1.8-.09.05-1.97 1.15-1.95 3.44.02 2.73 2.4 3.64 2.42 3.65-.02.06-.38 1.3-1.25 2.57l.14-.37ZM10.87 1.88c.59-.72 1.57-1.25 2.39-1.29.1 1.06-.31 2.12-.88 2.88-.56.76-1.48 1.35-2.39 1.27-.12-1.03.36-2.12.88-2.86Z"
                    fill="currentColor"
                  />
                </svg>
                Sign up with Apple
