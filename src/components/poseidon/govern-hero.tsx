  ...
  return (
    <HeroBento engine="govern">
      <div className="flex flex-col lg:flex-row w-full">
        {/* Col 1: Hero */}
        <div className="flex flex-col gap-4 flex-1 p-6 lg:p-10 justify-center">
          {/* Hero: "0 errors in N AI decisions" */}
          <div className="flex flex-col gap-2 lg:gap-4">
            <div className="flex items-baseline gap-3 flex-wrap">
              <span
                className="typo-hero-number text-[clamp(3.5rem,10vw,7rem)] leading-none font-mono"
                style={{ color: 'var(--engine-govern)' }}
              >
                <CountUp value={errorCount} locale duration={800} />
              </span>
              <span className="text-xl md:text-2xl lg:text-3xl text-white/60">
        ...
        {/* Col 2: Breakdowns & Guarantees */}
        <div className="flex flex-col gap-8 lg:min-w-[360px] lg:border-l lg:border-white/5 p-6 lg:p-10 justify-center bg-white/[0.02]">
          ...
          {trustGuarantees && (
            <div className="hidden md:flex flex-col gap-2 pt-3 border-t border-white/[0.06] mt-auto">
              <span className="text-[10px] font-semibold uppercase tracking-widest text-white/30">
        ...
        {/* Col 3: Audit Trail */}
        <div className="flex flex-col gap-4 p-6 lg:p-10 lg:w-[400px] shrink-0 border-t lg:border-t-0 lg:border-l border-white/5 bg-black/20">
