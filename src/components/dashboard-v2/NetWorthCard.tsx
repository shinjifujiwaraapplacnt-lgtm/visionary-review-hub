    ...
    <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 md:p-8 border-t-4 border-t-[var(--engine-dashboard)]">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-4xl md:text-5xl font-bold text-foreground font-mono tabular-nums mt-2">
            $<CountUp value={netWorth} duration={1500} decimals={2} />
          </p>
          <p className="text-sm font-medium text-emerald-500 flex items-center gap-1 mt-2">
      ...
      <div className="border-t border-white/[0.06] pt-5 mt-5 flex flex-wrap gap-6">
        <div>
